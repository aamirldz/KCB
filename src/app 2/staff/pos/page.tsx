                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2">
                            {filteredItems.map((item, index) => (
                                <motion.button
                                    ...
                                    className="bg-charcoal/50 border border-gray/10 overflow-hidden text-left hover:border-crimson/30 hover:bg-charcoal active:scale-95 transition-all group"
                                >
                                    {/* Image */}
                                    <div className="relative aspect-[4/3] overflow-hidden">
                                        ...
                                        />
                                        {/* Veg/Non-veg badge */}
                                        <div className={`absolute top-2 right-2 w-4 h-4 ${item.isVeg ? 'border-green-500 bg-green-500/20' : 'border-crimson bg-crimson/20'} border flex items-center justify-center backdrop-blur-sm`}>
                                            <div className={`w-2 h-2 ${item.isVeg ? 'bg-green-500' : 'bg-crimson'} rounded-full`} />
                                        </div>
                                    </div>
                                    {/* Info */}
                                    <div className="p-2">
                                        <h4 className="text-white text-xs font-medium line-clamp-2 mb-1 min-h-[2rem]">{item.name}</h4>
