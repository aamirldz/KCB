...
export default function HomePage() {
  return (
    <>
      ...
      <div className="h-20 md:h-32 bg-gradient-to-b from-black to-charcoal flex items-center justify-center">
      ...
      <div className="h-20 md:h-32 bg-gradient-to-b from-charcoal to-black flex items-center justify-center">
