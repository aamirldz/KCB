...
import { NAV_LINKS, TIMING } from '@/lib/constants';
            ...
            <div className="container">
                <nav className="flex items-center justify-between h-16 md:h-18">
                    ...
                    <Link href="/" className="flex items-center gap-4 group">
                        <span className="text-4xl md:text-5xl drop-shadow-[0_0_10px_rgba(217,119,6,0.4)]">🍜</span>
                        <div>
                            <span className="chinese text-gold text-lg md:text-xl font-semibold block leading-tight group-hover:text-gold-light transition-colors drop-shadow-[0_0_8px_rgba(217,119,6,0.3)]">国王中国碗</span>
                            <span className="text-white text-sm md:text-base font-bold tracking-[0.15em] uppercase group-hover:text-gold transition-colors">King Chinese Bowl</span>
                        </div>
                    </Link>
